...
from isaaclab.actuators import DCMotorCfg, DCMotor
...
class DelayedDCMotor(DCMotor):
    """DCMotor with delayed command application.

    This class extends the :class:`DCMotor` class by adding a delay to the actuator commands. The delay
...
class DelayedDCMotorCfg(DCMotorCfg):
    ...
    saturation_effort: float|dict[str, float] = MISSING
